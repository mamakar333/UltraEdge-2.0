...
> **UltraEdge 3.1** (`ultraedge.html`): up to 4 camera angles, and an **umpire view**: phones mirror this screen and control it, linked to a CrickVision match. Live at https://ultraedge.onrender.com/ultraedge.html (Render static site, `render.yaml`). See [ULTRAEDGE_GUIDE.md](ULTRAEDGE_GUIDE.md).
>
